      ...
      // Indigo line
      {
        ...
        backgroundColor: function (context) {
          ...
          return chartAreaGradient(ctx, chartArea, [
            {
              stop: 0,
              color: adjustColorOpacity(getCssVariable("--color-pink-500"), 0),
            },
            {
              stop: 1,
        ...
        pointRadius: 0,
        pointHoverRadius: 3,
        pointBackgroundColor: getCssVariable("--color-pink-500"),
        pointHoverBackgroundColor: getCssVariable("--color-pink-500"),
        pointBorderWidth: 0,
