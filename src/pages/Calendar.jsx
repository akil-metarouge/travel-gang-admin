            ...
            <div className="sm:flex sm:justify-between sm:items-center mb-4">
              ...
              <div className="mb-4 sm:mb-0 mr-2">
                <ul className="flex flex-wrap items-center -m-1">
                  ...
                  <li className="m-1">
                    <button className="btn-sm bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-500 dark:text-gray-400">
                      <div className="w-1 h-3.5 bg-pink-500 shrink-0"></div>
                  ...
                  <li className="m-1">
                    <button className="btn-sm bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-pink-500">
                      +Add New
                    </button>
                  </li>
                </ul>
              ...
              <div className="flex flex-nowrap -space-x-px">
                <button className="btn bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 text-pink-500 rounded-none first:rounded-l-lg last:rounded-r-lg">
                  Month
                </button>
                    ...
                    >
                      <div className="h-full flex flex-col justify-between">
                        ...
                        <div className="flex justify-between items-center p-0.5 sm:p-1.5">
                          ...
                          {/* Day number */}
                          <button
                            className={`inline-flex ml-auto w-6 h-6 items-center justify-center text-xs sm:text-sm dark:text-gray-300 font-medium text-center rounded-full hover:bg-pink-100 dark:hover:bg-gray-600 ${
